...
def make_datasets_model_ready(df_train: pd.DataFrame,df_test: pd.DataFrame)  -> (sparse.csr_matrix, sparse.csr_matrix, list):
    """
    ...
    col_names =col_transformer.named_transformers_['cats'].named_steps['ohe'] \
                                .get_feature_names()
...
def main(input_filepath, output_filepath):
    ...
    with open(WRITE_PATH+'/feature_names.pkl', 'wb') as f:
